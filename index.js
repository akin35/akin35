...
const BLOG_HOST = `https://blog.akinkuyga35.com`;

/* README Sections */
const introTitle = generateTitle(2, `Hey :wave:, I'm ${generateLink('Stanley', 'https://akinkuyga35.com/')}`);
const introDescription = `I'm currently a DevOps/Cloud Engineer at **${generateLink(
  'Snapchat',
  'https://www.snapchat.com/'
)}** and formerly at **${generateLink(
  'AWS',
  'https://aws.amazon.com/'
)}** based in 🌁 Canada. I am working on some side projects, learning a couple new dishes, and trying to conquer the world as Tannu Tuva in HOI4.`;
...
const badgeConfigs = [
  {
    ...
    logoBgColor: '4E69C8',
    logo: 'Firefox',
    link: 'https://akinkuyga35.com',
  },
  {
    name: 'Medium',
    badgeText: '@akinkuyga35',
    labelBgColor: '14c767',
    logoBgColor: '14c767',
    logo: 'Medium',
    link: 'https://medium.com/@akinkuyga35',
  },
  {
    name: 'LinkedIn',
    badgeText: '@akinkuyga',
    ...
    logoBgColor: '0077B5',
    logo: 'LinkedIn',
    link: 'https://www.linkedin.com/in/akinkuyga/',
  },
  {
    name: 'DevTo',
    badgeText: '@akin35',
...
const factsConfigs = [
  `🔭 I’m currently working on [Cirrus](https://github.com/akin35/AkinKuyga).`,
  `🧐 Learning about **serverless architectures**, **distributed systems**, and a bit of **ML**.`,
  `👨‍💻 Most of my projects are available on [Github](https://github.com/akin35).`,
//   `📝 I regulary write articles on [my blog](${BLOG_HOST}).`,
  `💬 Ping me about **react, koa, security, and cloud stuff**.`,
  `📙 Check out my [resume](https://www.akinkuyga35.com/resume/resume.pdf).`,
  `🎉 Fun Fact: 我也会讲中文。`,
];
